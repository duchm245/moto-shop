      ...
      <div className="footer-container">
        <div className="footer-expand-collapsed ">
          ...
          <div className="footer-copyright text-center">
            <div className="container">
              <p>
                Copyright © 2025 <Link to="https://github.com/duchm245/moto-shop"> MotoShop</Link>.
                <Link target="_blank" to="https://github.com/duchm245/moto-shop" rel="noreferrer">
                  Powered by MotoShop Team
                </Link>
              </p>
            </div>
          </div>
