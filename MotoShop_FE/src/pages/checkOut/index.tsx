      ...
      <div className="content">
        <div className="wrap">
                    ...
                    <table className="total-line-table">
                      ...
                      <tfoot className="total-line-table-footer">
                        ...
                        <tr className="total-line total-line-gift">
                          <td colSpan={2}>
                            <p>
                              Sau khi "Đặt hàng" thành công, MotoShop sẽ kiểm tra sản phẩm và đóng gói ngay để giao hàng
                              cho bạn. Trong quá trình kiểm tra sản phẩm nếu có phát sinh MotoShop sẽ liên hệ trực tiếp
                              với quý khách để xin xác nhận. MotoShop Xin chân thành cảm ơn!
                            </p>
                          </td>
                        </tr>
                      </tfoot>
          ...
          <div className="main">
            ...
            <div className="main-footer footer-powered-by">Powered by MotoShop Team</div>
          </div>
        </div>
      </div>
