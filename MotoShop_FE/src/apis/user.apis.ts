...
const userApi = {
  ...
  changePassword : (id, data) => httpRequest.put<SuccessResponse<string>, any>(`/api/user/changePassword/${id}`, data),
  updateProfile : (id, data) => httpRequest.post<SuccessResponse<string>, any>(`/api/user/update/${id}`, data),
}
